...
// Recaptcha verification route (for login page)
Route::post('verify-recaptcha', function () {
...
Route::prefix('settings')->group(function () {
    ...
    Route::middleware(['permission:global-setting,settings.app.globals'])->group(function () {
        ...
        Route::get('app/zohoFlow', [App\Http\Controllers\SettingsController::class, 'zohoFlow'])->name('settings.app.zohoFlow');
        Route::get('app/zohoFlow/test', [App\Http\Controllers\SettingsController::class, 'testZohoWebhook'])->name('settings.app.zohoFlow.test');
    });
...
Route::middleware(['permission:advertisements-list,advertisements.request'])->group(function () {
    Route::get('advertisements-list/requests', [App\Http\Controllers\AdvertisementsController::class, 'requested'])->name('advertisements.requests');
});    
